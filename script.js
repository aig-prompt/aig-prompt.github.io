            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4 text-xl">1</div>
                        <div class="flex-grow">
                            <p class="mb-10 text-lg"><strong>#Role :</strong> CFA와 CFP 자격을 가진 재무분석과 투자자문 전문가</p>
                            <p class="mb-2 text-lg"><strong>#Task</strong></p>
                            <p class="mb-2 text-lg"><strong>##</strong> 아래 작성하는 모든 자료의 단위는 Billion Dollar를 의미하는 'B'로 표시해</p>
                            <p class="mb-10 text-lg"><strong>##</strong> 아래의 순서대로 하나의 과제를 처리하고 다음 과제를 수행해</p>
                        ...
                        <div class="ml-4">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition duration-200 ease-in-out text-xl"
...
6. 애플 잉여 현금 흐름(5개년 동안의 OCF, CAPEX, OCF-CAPEX, 잉여현금흐름율)을 검색하고 표로 작성해.">
                                <svg class="h-10 w-10 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-4 text-lg">위 5가지 이슈에 대한 각 2개의 개선 아이디어를 7장의 슬라이드로 만들려고 합니다. 아래의 형식으로 슬라이드 아우트라인을 만드세요</p>
...
8페이지 : 마치는 말">
    ...
    <div class="bg-blue-600 flex flex-col h-screen">
        ...
        `
        <div class="bg-blue-600 flex flex-col h-screen">
            <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">(불렛제거)복수의 문서 데이터 분석 프롬프트</h2>
            <div class="flex-grow overflow-auto">
                <div class="space-y-6 px-8">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <div class="space-y-6">
...
`
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">창의적 문제 해결을 위한 프롬프트 예시</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">GPTs 제작 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            ...
                            <p class="mb-4 text-lg">사용자가 제시한 기업명에 대한 분석 보고서를 아래의 형식으로 작성해주세요.<br>가독성이 좋은 글머리를 이용하고 구성 요소별 다른 폰트 크기를 적용해 일목요연하게 작성해 주세요.</p>
...
- 실적">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">가사 작성을 위한 챗GPT 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            ...
                            <p class="mb-4 text-lg">당신의 역할은 20년차 Kpop 작곡,작사를 하는 싱어송라이터입니다.<br>아래의 정보로 우리 가족의 행복을 기원하는 곡을 만들어 주세요.</p>
                            
                            <p class="mb-2 text-lg font-bold">#정보</p>
                            <p class="mb-2 text-lg">1.아들 이름 : 송시윤</p>
...
사랑하는 사람이나 대상의 이름을 넣어 만들어 보세요">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">Ideogram 예시 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-4 text-lg">러브 마크가 장식된 검은 뿔테 안경을 쓰고 눈을 크게 뜬 채 미소 짓는 아빠.</p>
