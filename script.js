...
<div class="bg-blue-600 flex flex-col h-screen">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">비전 + 이미지 생성</h2>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        ...
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">위 첨부한 로고에 사용된 컬러와 디자인 스타일을 이용해서 20~30대 고객 대상 판촉물을 디자인해줘.<br>
- 제품 구성 : 다이어리, 볼펜, 노트, 지갑, 명합지갑 세트<br>
- 'Tesla' 브랜드명을 제품에 자연스럽게 노출시켜줘<br>
- 다음 순서에 맞춰서 진행해<br>
...
- 설명하는 언어는 한글로 해">
    ...
    `,
    `<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">웹브라우징 + 데이터 분석</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4 flex-shrink-0 self-start text-xl">1</div>
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">#Role : CFA와 CFP 자격을 가진 재무분석과 투자자문 전문가</p>
                            <p class="mb-2 text-lg">#Task</p>
                            <p class="mb-2 text-lg">## 아래 작성하는 모든 자료의 단위는 Billion Dollar를 의미하는 'B'로 표시해</p>
                            <p class="mb-2 text-lg">## 아래의 순서대로 하나의 과제를 처리하고 다음과제를 수행해</p>
                            <ol class="list-decimal list-inside">
                                <li>애플의 최근 5년간의 매출액과 당기순이익을 검색해서 표형식으로 작성해</li>
                                <li>애플의 매출 평균 성장률과 평균 순이익률을 계산하고 향후 3년간의 매출과 순이익을 예측해서 표형식으로 작성해</li>
                                <li>PER을 30,35,40을 적용해서 연도별 시가총액을 예상하고 위 2번 테이블에 3개의 열을 추가해</li>
                                <li>애플의 발행주식수를 검색해</li>
                                <li>위 3번의 시가총액에 아래의 공식을 적용해서 PER별로 향후 5년의 예상 주가를 파이썬을 이용해 라인 차트로 그려줘</li>
                                <li>애플 잉여 현금 흐름(5개년동안의 OCF,CAPEX,OCF-CAPEX,잉여현금흐름률)을 검색하고 표로 작성해.</li>
                            </ol>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
...
## 아래의 순서대로 하나의 과제를 처리하고 다음과제를 수행해

1. 애플의 최근 5년간의 매출액과 당기순이익을 검색해서 표형식으로 작성해
2. 애플의 매출 평균 성장률과 평균 순이익률을 계산하고 향후 3년간의 매출과 순이익을 예측해서 표형식으로 작성해
3. PER을 30,35,40을 적용해서 연도별 시가총액을 예상하고 위 2번 테이블에 3개의 열을 추가해
4. 애플의 발행주식수를 검색해
5. 위 3번의 시가총액에 아래의 공식을 적용해서 PER별로 향후 5년의 예상 주가를 파이썬을 이용해 라인 차트로 그려줘
6. 애플 잉여 현금 흐름(5개년동안의 OCF,CAPEX,OCF-CAPEX,잉여현금흐름률)을 검색하고 표로 작성해.">
                                <svg class="h-10 w-10 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3"></path></svg>
                                복사하기
                            </button>
                        </div>
                    ...
                    <div class="flex items-stretch">
                        ...
                        <div class="flex-grow">
                            ...
                            <div class="bg-gray-100 p-4 rounded-lg mt-2">
                                <p class="font-bold">예시 (복사X)</p>
                                <p>첨부한 파일은 포스코의 지속 가능 보고서입니다.<br>
                                나는 [포스코 인터내셔널]에서 [해외 사업 개발]을 하는 [사업개발본부장]을 맡고 있습니다.<br>
                                나와 관련된 관련된 내용에 포커스를 맞춰서 핵심내용을 한글로 요약하세요. 리스트 형식으로 쓰세요</p>
                            </div>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
...
액션 플랜은 최소 3단계에서 최대 10단계로 제안하세요">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">경영개선 아이디어로 PPT 생성</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-4 text-lg">위 5가지 이슈에 대한 각 2개의 개선 아이디어를 7장의 슬라이드로 만들려고 합니다. 아래의 형식으로 슬라이드 아웃라인을 만드세요</p>
                        ...
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                                    data-copy-text="위 5가지 이슈에 대한 각 2개의 개선 아이디어를 7장의 슬라이드로 만들려고 합니다. 아래의 형식으로 슬라이드 아웃라인을 만드세요
...
8페이지 : 마치는 말">
    ...
    <div class="bg-blue-600 flex flex-col h-screen">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="space-y-6">
                        <div class="flex items-stretch">
                            <div class="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4 flex-shrink-0 self-start text-xl">1</div>
                            <div class="flex-grow">
                                <p class="mb-2 text-lg">이 파일을 읽고 EDA 분석을 진행해. 결과는 한글로 작성해</p>
                            </div>
                        ...
                        <div class="flex items-stretch">
                            <div class="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4 flex-shrink-0 self-start text-xl">2</div>
                            <div class="flex-grow">
                                <p class="mb-2 text-lg">데이터 셋에서 A기업과 B기업의 연도별 탄소배출량 감소율을 비교해줘.</p>
                            </div>
                            <div class="flex-shrink-0 ml-4">
                                <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                        ...
                        <div class="flex items-stretch">
                            <div class="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold mr-4 flex-shrink-0 self-start text-xl">3</div>
                            <div class="flex-grow">
                                <p class="mb-2 text-lg">위 데이터 분석 결과를 시계열 라인차트로 시각화해줘.</p>
                            </div>
                            <div class="flex-shrink-0 ml-4">
                                <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
        ...
        `
        <div class="bg-blue-600 flex flex-col h-screen">
            <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">7. 복수의 문서 데이터 분석 프롬프트</h2>
            <div class="flex-grow overflow-auto">
                <div class="space-y-6 px-8">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <div class="space-y-6">
                            <div class="flex items-stretch">
                                <div class="flex-grow">
                                    <p class="mb-4 text-lg">글로벌 ESG 도전과제를 담은 차트 이미지와 포스코그룹의 ESG 리포트를 읽고 포스코 그룹에서 ESG 프로젝트를 진행할 때 필요한 인사이트를 추출해. 아래의 순서대로 진행해</p>
                                    <ol class="list-decimal list-inside space-y-2">
                                        <li>Image의 내용과 수치를 텍스트로 정리한다</li>
                                        <li>첨부한 포스코 그룹의 문서내의 ESG 과제 내용과 매핑한다</li>
                                        <li>매핑된 과제에 대한 점수를 참고해서 포스코에서 우선적으로 고려해야할 과제 리스트를 추출한다.</li>
                                        <li>정리된 과제 리스트별로 액션플랜을 수립한다.</li>
                                    </ol>
                                </div>
                                <div class="flex-shrink-0 ml-4 h-full">
                                    <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
...
`
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">8. 창의적 문제 해결을 위한 프롬프트 예시</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">• 2030년 포스코 그룹 시총이 애플을 넘어서 전세계 시총 1위가 되었다. 이 순간을 위해 포스코는 2025년 부터...</p>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                    ...
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">• NASA에서 급히 포스코 연구진을 펜타곤으로 초청했다면 나사에서는 포스코에게...</p>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                    ...
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">• 포스코가 넷플릭스와 함께 영화를 제작해 세상을 놀라게 했다. 그 주제는 바로...</p>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                    ...
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-2 text-lg">• 2025년 포스코가 롤렉스를 인수했다. 2030년에 사람들은 포스코를 이렇게 부르는데...</p>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">9. GPTs 제작 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            ...
                            <p class="mb-4 text-lg">당신은 기업 분석 전문가입니다.<br>당신은 기업의 재무 정보와 뉴스를 분석하여 기업에 대한 정보를 일목요연하게 정리합니다.</p>
                            
                            <p class="mb-2 text-lg font-bold"># Objective</p>
                            <p class="mb-4 text-lg">사용자가 제시한 기업명에 대한 분석 보고서를 아래의 형식으로 작성해주세요.<br>독창이 좋은 클러리를 이용하고 구성 요소별 다른 폰트 크기를 적용해 일목요연하게 작성해 주세요.</p>
                            
                            <p class="mb-2 text-lg font-bold">1. 회사 개요</p>
                            <p class="mb-2 text-lg">- 사업 포트폴리오에 대한 상세한 설명<br>- 최근 1년 내 회사 동향 (주요 사건, 신제품 출시 등)</p>
                            
                            <p class="mb-2 text-lg font-bold">2. 산업 분석</p>
                            <p class="mb-2 text-lg">- 시장 환경<br>- 주요 경쟁사 및 시장 위치<br>- 산업 동향 및 전망</p>
                            
                            <p class="mb-2 text-lg font-bold">3. 재무 분석</p>
                            <p class="mb-2 text-lg">- 재무 상태<br>- 실적</p>
                        </div>
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                                    data-copy-text="# Role
...
독창이 좋은 클러리를 이용하고 구성 요소별 다른 폰트 크기를 적용해 일목요연하게 작성해 주세요.
...
- 실적">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">10. 가사 작성을 위한 챗GPT 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-2 text-lg font-bold">#역할</p>
                            <p class="mb-4 text-lg">당신의 역할은 20년차 Kpop 작곡,작사를 하는 숙여 송라이터입니다.<br>아래의 정보로 우리 가족의 행복을 기원하는 곡을 만들어 주세요.</p>
                            
                            <p class="mb-2 text-lg font-bold">#정보</p>
                            <p class="mb-2 text-lg">1.아들 이름 : 승시윤</p>
                        ...
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                                    data-copy-text="#역할
당신의 역할은 20년차 Kpop 작곡,작사를 하는 숙여 송라이터입니다.
...
사랑하는 사람이나 대상의 이름을 넣어 만들어 보세요">
    ...
    `
<div class="bg-blue-600 flex flex-col h-screen">
    <h2 class="text-4xl font-bold text-white mb-4 px-8 pt-4">11. Ideogram 예시 프롬프트</h2>
    <div class="flex-grow overflow-auto">
        <div class="space-y-6 px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="space-y-6">
                    <div class="flex items-stretch">
                        <div class="flex-grow">
                            <p class="mb-4 text-lg">러브 마크가 장식된 검은 빛의 안경을 쓰고 눈을 크게 뜬 채 미소 짓는 아빠.</p>
                            <p class="mb-4 text-lg">섬세하고 선명한 일러스트로 그리세요.</p>
                            <p class="mb-4 text-lg">이미지 아래에는 흰색과 파란색이 쉬인 티셔츠에 노란색에서 주황색, 빨간색으로 바뀌는 생생한 손글씨 글꼴로 "Super Dad"라는 단어가 적혀 있습니다.</p>
                        ...
                        <div class="flex-shrink-0 ml-4 h-full">
                            <button class="copy-button px-6 py-4 rounded bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-300 focus:outline-none transition-colors duration-200 ease-in-out flex flex-col items-center justify-center h-full text-xl"
                                    data-copy-text="러브 마크가 장식된 검은 빛의 안경을 쓰고 눈을 크게 뜬 채 미소 짓는 아빠.

섬세하고 선명한 일러스트로 그리세요.

이미지 아래에는 흰색과 파란색이 쉬인 티셔츠에 노란색에서 주황색, 빨간색으로 바뀌는 생생한 손글씨 글꼴로 'Super Dad'라는 단어가 적혀 있습니다.
...
<div class="bg-indigo-600 flex flex-col h-screen p-8">
    ...
    <div class="mt-8 text-white space-y-2">
        <div class="flex items-center">
            ...
            <p>분기 보고서 파일은 자사 회사 홈페이지나 공시자료를 다운로드 받아서 사용��� 주세요</p>
        </div>
        <div class="flex items-center">
